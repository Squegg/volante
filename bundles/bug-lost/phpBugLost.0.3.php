 ...
 */
function bl_query($query, $bindings, $time) {
	...
	_bl::$msg_sql[$c]['bindings'] = $bindings;
	_bl::$msg_sql[$c]['time'] = $time;
	_bl::$msg_sql[$c]['insert'] = 0;
	_bl::$msg_sql[$c]['result'] = array();
	_bl::$msg_sql[$c]['explain'] = array();
	_bl::$msg_sql[$c]['error'] = '';
	_bl::$msg_sql[$c]['file'] = '';
	_bl::$msg_sql[$c]['line'] = '';
}
		...
		foreach ($bl_msg_sql as $k => $v) {
			...
			$result .= '
                <tr onmouseover="bl_highlight_row(true, this)" onmouseout="bl_highlight_row(false, this)">
                    ...
                    <td>' . implode(', ', array_values($v['bindings'])) . '</td>
                </tr>';
		}
