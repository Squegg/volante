<div id="main">
	...
	<?= Form::open('admin/layouts/add', 'POST', array('class' => 'form-horizontal')) ?>
		...
		<?= Form::field('select', 'type', __('admin_layouts.add.form.type'), array(Layout::$types, array(Input::old('type'))), array('error' => $errors->first('type'))) ?>
		<div id="normal">
		...
		<div id="split">
			...
			<?= Form::field('textarea', 'before', __('admin_layouts.add.form.before'), array(Input::old('before'), array('style' => 'width: 770px; height: 350px')), array('error' => $errors->first('before'))) ?>
			...
			<?= Form::field('textarea', 'after', __('admin_layouts.add.form.after'), array(Input::old('after'), array('style' => 'width: 770px; height: 350px')), array('error' => $errors->first('after'))) ?>
		</div>
